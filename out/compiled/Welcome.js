  ...
  function create_fragment(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        h4 = element("h4");
        h4.textContent =
          "Hatchways Live Coding Interview Tool allows you to conduct interviews in back-end, front-end or fullstack projects. Follow this guide below to see your next steps.";
        t3 = space();
        div0 = element("div");
        h20 = element("h2");
        i1 = element("i");
        ...
        p0 = element("p");
        p0.textContent =
          "On the Sidebar, you should see a text field to input your name. Enter your name then press Submit.";
        t7 = space();
        div1 = element("div");
        h21 = element("h2");
        i2 = element("i");
        ...
        p1 = element("p");
        p1.textContent =
          "To run your code, you can use the terminal below and follow the instructions in the README.md to see your code changes.";
        t11 = space();
        div2 = element("div");
        h22 = element("h2");
        i3 = element("i");
        ...
        p2 = element("p");
        p2.textContent =
          "You will be able to collaborate with other people who join the live session links.";
        t15 = space();
        img = element("img");
        ...
        if (
          !src_url_equal(
            img.src,
            (img_src_value =
              "https://imgix-blog.setapp.com/coderunner-ventura.webp?auto=format&ixlib=php-3.3.1&q=75")
          )
        )
